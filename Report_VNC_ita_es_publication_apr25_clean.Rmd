...
# Load data
  romall<-readxl::read_excel("romall_new.xlsx")
  
  nc<-readxl::read_excel("noncaus_new.xlsx")
...
```{r}
# Summarize the dataset by language, lemma, and period

summary_table <- join %>%
  group_by(language, lemma, period) %>%
  summarise(
