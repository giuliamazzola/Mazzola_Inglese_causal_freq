...
* Step 2: Create a new variable with the years groups in 70-years periods. Periods are indicated with the central years in the 70 years span, i.e. 1175 stands for the period between 1140 and 1210. The range of years in the italian dataset is `r range(ita$year)` and for Spanish `r range(esp$year)`.
...
ggplot(fit2, aes(x = period_cat, y = proportion_anticausative)) +
  geom_smooth(aes(y = fit, group = 1), color = "#fc8961", linewidth = 1.2, se=F) +
  #facet_wrap(~ language) +
  labs(
    title = "Effect of Time Period on Anticausative Proportion",
